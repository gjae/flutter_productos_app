...
class RegistroPage extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SizedBox(height: 32),
          FlatButton(
            child: Text("¿Ya tiene una cuenta?, inicie sesión", style: TextStyle(fontSize: 15.0, color: Colors.deepPurple)),
  ...
  void _register(LoginBloc bloc, BuildContext context) async {
    final resp = await usuarioProvider.registrarUsuario(bloc.email, bloc.password);
  ...
  mostrarAlerta(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Puede que su correo ya este siendo usado'),
        actions: [
          FlatButton(
            child: Text("Aceptar"),
